...
- The pageinated products should be displayed in the app using a simple card or grid layout
- A "Load more" should be included in the UI and allow the user to load the next set of paginated data
